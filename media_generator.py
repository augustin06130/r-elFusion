...
# def create_video(audio_file, background_video="video.mp4", output="output.mp4", text=None):
#     """
...
# def process_video_from_text(text, background_video="video.mp4", output="output.mp4", lang='fr', add_subtitles=True):
#     """
